    ...
    <v-row align="center">
      <v-col sm="12">
        <p>
          ...
          porque as soluções são periódicas, $$\begin{split}0 &
          =\ln(x(T))-\ln(x(0)) = \int_0^T {d\over dt} \ln(x) \, dt \\ &=
          \int_0^Ta-b\, y(t)\, dt \end{split} $$ de onde $ {1\over T}\int_0^T
          y(t) dt = a/b.$ A outra igualdade é similar.
        </p>
      </v-col>
    </v-row>
  </v-container>
